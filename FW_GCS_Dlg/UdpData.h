...
//     // 帧头 (序号1)
//     uint16_t frameHeader;  // 固定值0x55AA (小端存储: 内存中为AA 55)
    
//     // 字节长度 (序号2)
//     uint16_t dataLength;    // 整个数据帧长度
    
//     // 任务指令 (序号3)
//     uint8_t missionCommand;
    
//     // 控制模式 (序号4)
//     uint8_t controlMode;
    
//     // 发射点 (序号5-7)
//     int32_t launchLongitude;
//     int32_t launchLatitude;
//     int16_t launchAltitude;
...
//     // 初始角速率 (序号11-13)
//     int16_t initPitchRate;
//     int16_t initYawRate;
//     int16_t initRollRate;
    
//     // 初始速度 (序号14-16)
//     int16_t initNorthVelocity;
//     int16_t initEastVelocity;
//     int16_t initVerticalVelocity;
    
//     // 初始加速度 (序号17-19)
//     int16_t initNorthAccel;
//     int16_t initEastAccel;
//     int16_t initVerticalAccel;
...
//     // 发射点(重复?) (序号30-32)
//     int32_t launchLongitude2;
//     int32_t launchLatitude2;
//     int16_t launchAltitude2;
    
//     // 开伞点 (序号33-35)
//     int32_t parachuteLongitude;
//     int32_t parachuteLatitude;
//     int16_t parachuteAltitude;
